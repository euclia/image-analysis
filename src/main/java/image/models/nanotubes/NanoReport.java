...
public class NanoReport {
    ...
    private ArrayList<NanoResult> nanoSummaryReports;
    ...
    public NanoReport(ArrayList<Lines> resultLines, ArrayList<Junctions> resultJunction, ImagePlus resultImage) {
    ...
    public ArrayList<NanoResult> getNanoSummaryReports() {
        return nanoSummaryReports;
    }

    public void setNanoSummaryReports(ArrayList<NanoResult> nanoSummaryReports) {
