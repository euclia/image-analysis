 ...
 */
@Named("agglomerateController")
@SessionScoped
public class AgglomerateController implements Serializable {
...
//    private final String SPHERICAL_IMAGE_PATH = "/resources/spherical.jpg";
    ...
    private final String AGGLOMERATES_IMAGE_PATH = "/resources/agglomersPreProcessed.png";
...
//                "application/octet-stream", "AgglomersPreProcessingOnly.ijm");
    ...
    public String submitForm() {
        try {
            ...
            java.util.List<ParticleResult> resultMap = new ArrayList<>();
            if (this.function.equals(IMAGEANALYSIS)) {
                this.result = applicationMain.analyseAgglomeratedImage();
            } else {
                this.result = applicationMain.countAgglomeratedParticles();
            }
        ...
        return "agglomerates_result?faces-redirect=true";
    }
    ...
    public void setMeasurements(java.util.List<String> measurements) {
...
//            temp = applicationMain.applyAgglomeratedThreshold(this.thresholdType);
...
//    public DefaultStreamedContent getPlugin() {
...
//    }
    ...
    public void useExample() {
        try {
            bufferedImage = ImageIO.read(context.getResourceAsStream(AGGLOMERATES_IMAGE_PATH));
...
//    public DefaultStreamedContent file(){
//        DefaultStreamedContent file = new DefaultStreamedContent();
//        
//        file.setName("AgglomersPreProcessingOnly.ijm");
//        file.setContentType("application/octet-stream");
//        file.setStream(FacesContext.getCurrentInstance().getExternalContext().getResourceAsStream("/resources/demo/images/AgglomersPreProcessingOnly.ijm"));
//        
//        return file;
//        
//    }
